...
import Backend.Helper.Datum;
import Backend.Helper.StripEntry;
import Backend.Validator.BooleanValidator;
import Backend.Validator.CurrencyValidator;
import Backend.Validator.DiscountValidator;
import Backend.Validator.EndDateValidator;
import Backend.Validator.PaymentValidator;
...
public class MitgliederVertrag {
    ...
    public String toString() {
        ...
        return String.format(
            ...
            + "Trainingsbeginn: %s\n"
            + "Status: %s\n"
            + "Preisrabatt: %.2f | IntervallID: %d | ZahlungID: %d | MitarbeiterID: %d\n"
            + "Kommentar: %s",
            vertragNr,
            mitgliederID,
            vertragID,
